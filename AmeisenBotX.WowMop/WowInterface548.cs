...
using AmeisenBotX.WowMop.Hook;
using AmeisenBotX.WowMop.Objects;
using System.Text;
using System.Text.Json;
using System.Text.Json.Serialization;

namespace AmeisenBotX.WowMop
{
    /// <summary>
    ...
    public class WowInterface548 : IWowInterface
    {
        ...
        {
            // MoP 5.4.8 specific CVars for maximum bot performance
            ...
            // Display - Potato mode (MoP uses different CVars)
            ...
            cvars.Append("pcall(SetCVar,\"MSAAQuality\",\"0\");");
            cvars.Append("pcall(SetCVar,\"gxMultisample\",\"1\");");
            cvars.Append("pcall(SetCVar,\"tripleBuffer\",\"0\");");
            cvars.Append("pcall(SetCVar,\"vsync\",\"0\");");
            cvars.Append("pcall(SetCVar,\"gxCursor\",\"0\");");

            // Shadows - Off (MoP uses different shadow system)
            cvars.Append("pcall(SetCVar,\"shadowMode\",\"0\");");
            cvars.Append("pcall(SetCVar,\"shadowTextureSize\",\"0\");");
            cvars.Append("pcall(SetCVar,\"shadowSoft\",\"0\");");
            ...
            // Water - Off
            cvars.Append("pcall(SetCVar,\"waterDetail\",\"0\");");
            cvars.Append("pcall(SetCVar,\"rippleDetail\",\"0\");");
            cvars.Append("pcall(SetCVar,\"reflectionMode\",\"0\");");

            // Particles & Effects - Off
            cvars.Append("pcall(SetCVar,\"particleDensity\",\"0\");");
            cvars.Append("pcall(SetCVar,\"spellEffectLevel\",\"0\");");
            cvars.Append("pcall(SetCVar,\"ffxGlow\",\"0\");");
            cvars.Append("pcall(SetCVar,\"ffxDeath\",\"0\");");
            cvars.Append("pcall(SetCVar,\"weatherDensity\",\"0\");");
            cvars.Append("pcall(SetCVar,\"showFootsteps\",\"0\");");

            // Textures - Lowest
            cvars.Append("pcall(SetCVar,\"graphicsTextureResolution\",\"0\");");
            cvars.Append("pcall(SetCVar,\"graphicsTextureFiltering\",\"0\");");
            cvars.Append("pcall(SetCVar,\"projectedTextures\",\"0\");");

            // Lighting - Minimum
            cvars.Append("pcall(SetCVar,\"lightMode\",\"0\");");
            cvars.Append("pcall(SetCVar,\"lightingQuality\",\"0\");");

            // Models & LOD - Maximum culling
            cvars.Append("pcall(SetCVar,\"graphicsViewDistance\",\"0\");");
            cvars.Append("pcall(SetCVar,\"graphicsLiquidDetail\",\"0\");");
            cvars.Append("pcall(SetCVar,\"graphicsSunshafts\",\"0\");");
            cvars.Append("pcall(SetCVar,\"graphicsSSAO\",\"0\");");
            ...
            cvars.Append("pcall(SetCVar,\"Sound_EnableAllSound\",\"0\");");
            ...
            cvars.Append("pcall(SetCVar,\"floatingCombatTextCombatDamage\",\"0\");");
            cvars.Append("pcall(SetCVar,\"floatingCombatTextCombatHealing\",\"0\");");
        ...
        public string GetGameObjectName(int entryId)
        {
            throw new NotImplementedException();
        }

        public string GetUnitName(int entryId)
        {
            throw new NotImplementedException();
        }
    }
