            ...
            if (TryFindTarget(TargetProviderDps, out _))
            {
                ...
                if (Bot.Target != null)
                {
                    ...
                    else
                    {
                        ...
                        if ((Bot.Objects.All.OfType<IWowUnit>().Count(e => Bot.Target.Position.GetDistance(e.Position) < 16.0) > 2 && TryCastSpell(Hunter335a.MultiShot, Bot.Wow.TargetGuid, true))
