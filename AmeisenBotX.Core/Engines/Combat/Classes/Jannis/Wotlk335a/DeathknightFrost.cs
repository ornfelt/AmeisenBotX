...
{
    [CombatClassMetadata("[WotLK335a] Deathknight Frost", "Jannis")]
        ...
        public override void Execute()
        {
            ...
            if (TryFindTarget(TargetProviderDps, out _))
            {
                ...
                if ((Bot.Player.HealthPercentage < 60
                        && TryCastSpellDk(DeathknightWotlk.IceboundFortitude, 0, true))
                    || TryCastSpellDk(DeathknightWotlk.UnbreakableArmor, 0, false, false, true)
                    || TryCastSpellDk(DeathknightWotlk.Obliterate, Bot.Wow.TargetGuid, false, false, true, true)
