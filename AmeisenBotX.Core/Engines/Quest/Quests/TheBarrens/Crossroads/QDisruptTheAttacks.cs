...
{
    internal class QDisruptTheAttacks(AmeisenBotInterfaces bot) : BotQuest(bot, 871, "Disrupt the Attacks", 9, 1,
            () => (bot.GetClosestQuestGiverByNpcId(bot.Player.Position, [3429]), new Vector3(-473.20f, -2595.70f, 103.81f)),
            () => (bot.GetClosestQuestGiverByNpcId(bot.Player.Position, [3429]), new Vector3(-473.20f, -2595.70f, 103.81f)),
            [
                    new QuestObjectiveChain(
                    [
                        new KillAndLootQuestObjective(bot, [3267], 8, 0, [
                            [
                        ...
                        new KillAndLootQuestObjective(bot, [3268], 8, 0, [
                            [
                        ...
                        new KillAndLootQuestObjective(bot, [3265], 3, 0, [
                            [
