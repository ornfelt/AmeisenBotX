...
{
    internal class QStingOfTheScorpid(AmeisenBotInterfaces bot) : BotQuest(bot, 789, "Sting of the Scorpid", 1, 1,
            () => (bot.GetClosestQuestGiverByNpcId(bot.Player.Position, [3143]), new Vector3(-600.13f, -4186.19f, 41.27f)),
            () => (bot.GetClosestQuestGiverByNpcId(bot.Player.Position, [3143]), new Vector3(-600.13f, -4186.19f, 41.27f)),
            [
