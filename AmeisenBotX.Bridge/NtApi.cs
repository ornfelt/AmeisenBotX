...
public static unsafe partial class NtApi
{
    ...
    static NtApi()
    {
        ...
        ProcessIdToSessionId(GetCurrentProcessId(), out uint id);
        _sessionId = (int)id;
    }
    ...
    {
        RtlInitUnicodeString(out UNICODE_STRING objectName, name);
        OBJECT_ATTRIBUTES objAttr = OBJECT_ATTRIBUTES.Create(&objectName);
